      ...
      <div
        className={cn(
          ...
          variant === "plain"
            ...
            : "bg-surface-container text-on-surface p-3 rounded-sm shadow-3 min-w-[calc(var(--uni-sys-u)*50)] whitespace-normal flex flex-col gap-1 border border-outline-variant/30",
          className
        )}
      >
