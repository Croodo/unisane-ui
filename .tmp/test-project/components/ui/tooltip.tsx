      ...
      <div
        className={cn(
          ...
          variant === "plain"
            ...
            : "bg-surface-container text-on-surface p-3u rounded-sm shadow-3 min-w-[calc(var(--uni-sys-u)*50)] whitespace-normal flex flex-col gap-1u border border-outline-variant/30",
          className
        )}
      >
