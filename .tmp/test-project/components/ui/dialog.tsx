  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          <div className="px-8 py-6 border-b border-outline-variant/10 flex items-center justify-between bg-surface-container-low/50 shrink-0">
             <div className="flex items-center gap-4 text-left">
              ...
              <button 
                onClick={onClose} 
                className="w-10 h-10 rounded-sm flex items-center justify-center text-on-surface-variant hover:text-on-surface hover:bg-surface-variant transition-all relative overflow-hidden shrink-0"
          ...
          <div className={cn("flex-1 overflow-y-auto max-h-[75vh]", contentClassName)}>
               <div className="text-on-surface p-8 text-left">
                  <Text
                    variant="bodyMedium"
                    id={descId}
                    as="div"
