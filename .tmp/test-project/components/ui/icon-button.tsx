...
const iconButtonVariants = cva(
  "relative inline-flex items-center justify-center rounded-sm transition-all duration-snappy ease-emphasized overflow-hidden disabled:opacity-38 disabled:cursor-not-allowed group focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary select-none",
  {
    variants: {
      variant: {
