/**
 * Plan Map Configuration
 *
 * Maps friendly plan codes (e.g., "pro") to provider-specific identifiers
 * (Stripe price IDs or Razorpay plan_ids).
 *
 * Configuration via BILLING_PLAN_MAP_JSON env var:
 * {
