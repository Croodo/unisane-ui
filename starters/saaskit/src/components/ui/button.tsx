  ...
  "relative inline-flex items-center justify-center gap-2 rounded-xl font-medium transition-all duration-short ease-standard overflow-hidden focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary disabled:opacity-38 disabled:cursor-not-allowed group whitespace-nowrap leading-none select-none",
  {
    variants: {
      variant: {
        ...
        outline: "border border-outline text-primary bg-transparent", // alias for "outlined"
        text: "text-primary bg-transparent",
        elevated: "bg-surface-container-low text-primary shadow-1",
        // shadcn compatibility aliases
        default: "bg-primary text-on-primary", // maps to filled
        secondary: "bg-secondary-container text-on-secondary-container", // maps to tonal
        destructive: "bg-error text-on-error hover:bg-error/90",
        ghost: "text-on-surface bg-transparent hover:bg-surface-container",
...
export interface ButtonProps
  ...
  children: ReactNode;
  variant?: "filled" | "tonal" | "outlined" | "outline" | "text" | "elevated" | "default" | "secondary" | "destructive" | "ghost" | "link";
  size?: "sm" | "md" | "lg" | "icon" | "icon-xs" | "icon-sm";
  loading?: boolean;
  icon?: ReactNode;
