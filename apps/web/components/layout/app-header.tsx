...
export function AppHeader() {
  return (
    <header className="hidden md:block w-full">
      ...
      <div className="h-20u flex items-center justify-between gap-6u px-6u md:px-12u container mx-auto max-w-[1600px]">
        {/* Leading Section: Logo & Title */}
        <Link
          href="/"
          className="flex items-center gap-3u shrink-0 select-none cursor-pointer group"
        >
          {/* Logo Mark */}
          <UnisaneLogo
            size={32}
          ...
          <Typography variant="titleLarge" component="span">
            Unisane
            <span className="font-semibold text-on-surface-variant ml-2">
              UI
            </span>
          </Typography>
        </Link>
        ...
        <div className="flex items-center gap-1u shrink-0">
          ...
          >
            <svg viewBox="0 0 24 24" className="w-6u h-6u fill-current">
