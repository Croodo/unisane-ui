      ...
      <div className="h-20 flex items-center justify-between gap-6 px-6 expanded:px-12 container mx-auto max-w-[1600px]">
        ...
        <div className="flex-1 min-w-0 px-4">
          <div className="relative group w-full transition-transform duration-200 focus-within:scale-[1.01]">
            ...
            <input
              type="text"
              className="block w-full pl-12 pr-4 h-14 bg-surface-container hover:bg-surface-container-high focus:bg-surface-container-high rounded-full text-body-large text-on-surface placeholder:text-on-surface-variant focus:outline-none focus:ring-2 focus:ring-primary transition-all duration-200"
        ...
        <div className="flex items-center gap-1 shrink-0">
          <a
            ...
            className="w-12 h-12 rounded-full hover:bg-surface-container-highest flex items-center justify-center text-on-surface-variant transition-colors"
