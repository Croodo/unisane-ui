    ...
    >
      ...
      {isOpen && !disabled && (
        <div
          ...
          role="listbox"
          aria-labelledby={label ? labelId : undefined}
          className="absolute top-[calc(100%+var(--unit))] left-0 w-full bg-surface border border-outline-variant rounded-sm shadow-3 py-1u max-h-[calc(var(--unit)*70)] overflow-y-auto z-[100] animate-in fade-in zoom-in-95 duration-snappy"
        >
          {options.length > 0 ? (
