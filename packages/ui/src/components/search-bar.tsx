...
export const SearchBar: React.FC<SearchBarProps> = ({
  ...
  return (
    <div
      role="search"
      className={cn(
        "group relative flex items-center w-full h-14 rounded-sm bg-surface-container border border-outline-variant/30 hover:bg-surface-container-high focus-within:bg-surface-container-high transition-all duration-medium ease-standard cursor-text",
        className
      )}
    >
