      ...
      >
        <header className="px-6 py-4 border-b border-outline-variant flex items-center justify-between bg-surface shrink-0 z-20">
          <div className="flex items-center gap-3">
            {icon && (
               <div className="w-10 h-10 rounded-xs bg-inverse-surface text-inverse-on-surface flex items-center justify-center shrink-0 shadow-1 transition-all duration-short ease-standard">
                  {icon}
               </div>
            )}
            <div className="flex flex-col">
              ...
              <div className="text-on-surface-variant font-bold uppercase tracking-widest text-label-small mt-1 flex items-center gap-1_5">
          ...
          <button 
            onClick={onClose} 
            className="w-10 h-10 rounded-xs flex items-center justify-center text-on-surface-variant hover:text-on-surface hover:bg-surface-container-high transition-all relative overflow-hidden"
        ...
        {(footerLeft || footerRight) && (
          <footer className="px-6 py-4 border-t border-outline-variant bg-surface-container-low shrink-0 z-20 shadow-2">
