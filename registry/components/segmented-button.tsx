      ...
      {options.map((option, index) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex-1 px-4 min-w-fit whitespace-nowrap text-label-small font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all relative focus-visible:outline-2 focus-visible:outline-primary focus-visible:z-10 select-none",
...
const segmentedButtonItemVariants = cva(
  "flex-1 px-4 min-w-fit whitespace-nowrap text-label-small font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all relative select-none",
  {
    variants: {
      active: {
