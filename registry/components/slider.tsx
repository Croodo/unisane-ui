...
export const Slider: React.FC<SliderProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-1 rounded-full flex items-center">
        <div
          className={cn(
      ...
      >
        {!disabled && (
          <div
            className={cn(
              "absolute w-10 h-10 rounded-full bg-primary transition-opacity duration-medium ease-standard",
        ...
        <div
          className={cn(
            "rounded-full shadow-1 transition-all duration-medium ease-emphasized",
            disabled
              ? "bg-on-surface/38 w-3 h-3 shadow-none"
          ...
          {shouldShowLabel && !disabled && (
            <div
              className={cn(
                ...
                "flex items-center justify-center bg-inverse-surface text-inverse-on-surface text-label-small font-black rounded-full shadow-2",
