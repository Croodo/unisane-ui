        ...
        return (
          ...
          >
            {!isLast && (
              <div
                className={cn(
                  "absolute top-4 left-1/2 w-full h-0_5u transition-colors duration-medium ease-standard z-0",
            ...
            <div
              className={cn(
                "w-8 h-8 rounded-xs flex items-center justify-center text-label-small font-black border-2 z-10 transition-all duration-emphasized ease-emphasized",
            ...
            <div className="mt-4 text-center px-2 max-w-[calc(var(--unit)*30)]">
              ...
              {step.description && (
                <span className="hidden @md:block text-label-small font-bold text-on-surface-variant/60 uppercase mt-1 leading-none tracking-tighter">
                  {step.description}
                </span>
              )}
            </div>
