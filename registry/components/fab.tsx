...
const fabVariants = cva(
  "inline-flex items-center justify-center gap-2 transition-all duration-medium ease-emphasized cursor-pointer overflow-hidden relative group shrink-0 z-30 select-none",
  {
    variants: {
      variant: {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-center gap-3 pointer-events-none">
        ...
        {label && (
          <span className="text-label-large font-medium leading-none pt-0_5">
            {label}
          </span>
        )}
        {children}
