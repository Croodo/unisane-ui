      ...
      >
        {actions.map((action, index) => (
          <div key={index} className="flex items-center gap-3 group" role="none">
            <span className="bg-inverse-surface text-inverse-on-surface text-label-small font-medium py-1 px-2 rounded-md shadow-1 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap" aria-hidden="true">
              {action.label}
            </span>
            <Fab
              size="sm"
